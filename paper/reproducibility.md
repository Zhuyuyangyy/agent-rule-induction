...
Note: P4 artifacts are generated at runtime in `results/p4_open_ended_search/` and are not currently tracked in `docs/artifacts/`. This is a known gap — P4 results should be regenerated by running the benchmark.
